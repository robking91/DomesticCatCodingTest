...
protocol FavoriteRestaurantProtocol {
...
class RestaurantListViewController: UITableViewController {
   ...
   override func viewDidLoad() {
      super.viewDidLoad()
      navigationItem.title = "Abbotsford"
      registerCell()
   ...
   func fetchRestaurants() {
      if isConnectedToInternet() {
         ...
         viewModel.fetchCachedRestaurants()
      }
   }
...
extension RestaurantListViewController: FavoriteRestaurantProtocol {
